...
robocopy_args = "/MIR /R:5 /W:5 /ZB /NFL /NDL /NP /MT:8"
...
# Can also specify target drive:/folder excluding trailing slash to target a subfolder in destination,
drive = "J:"
...
def backup(source, dest, logname):
    ...
    print(backupcmd)
    try:
        proc = subprocess.Popen(backupcmd, stdin=None, stdout=subprocess.PIPE, stderr=subprocess.STDOUT, shell=False, bufsize=1, universal_newlines=True)
